...
namespace Nop.Plugin.Payments.BrainTree
{
    public class BrainTreePaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public ProcessPaymentResult ProcessPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            string merchantAccountId = _brainTreePaymentSettings.MerchantAccountId;
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.BrainTree.Fields.MerchantAccountId", "Merchant AccountID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.BrainTree.Fields.MerchantAccountId.Hint", "Enter Merchant AccountID");
